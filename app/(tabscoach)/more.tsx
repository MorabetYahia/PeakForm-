  ...
  async function getUserProfile() {
    try {
      ...
      if (user) {
        ...
        // Get coach stats (mocked for now - replace with actual queries)
      ...
      >
        <View style={styles.container}>
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <View style={styles.userStatusBadge}>
                      ...
                      <Text style={styles.userStatusText}>Coach</Text>
                    </View>
                  </>
                )}
              </View>
            ...
            {!loading && (
              ...
              >
                <View style={styles.statItem}>
                  <Text style={styles.statValue}>{coachStats.clients}</Text>
                  <Text style={styles.statLabel}>Clients</Text>
                </View>
                <View style={styles.statDivider} />
                <View style={styles.statItem}>
                  <Text style={styles.statValue}>{coachStats.sessions}</Text>
                  <Text style={styles.statLabel}>Sessions</Text>
                </View>
                <View style={styles.statDivider} />
                <View style={styles.statItem}>
                  <Text style={styles.statValue}>{coachStats.reviews}</Text>
          ...
          <View style={styles.settingsSection}>
            ...
            >
              <View style={styles.settingItemContent}>
                <Ionicons name="cash-outline" size={24} color="#b300ff" />
                <Text style={styles.settingText}>Revenue</Text>
                <Ionicons name="chevron-forward" size={24} color="#999" />
              </View>
            </TouchableOpacity>          
